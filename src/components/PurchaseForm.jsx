...
function PurchaseForm({ data, setData }) {
    ...
    <div className="space-y-4">
      <div className="bg-green-50 p-4 rounded-lg mb-4">
        ...
        <p className="text-sm text-gray-600">
          Meminjam bank dengan bunga declining balance, depresiasi metode garis lurus
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <input
            type="number"
            value={localValues.interestRate !== undefined ? localValues.interestRate : data.interestRate}
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">
            Biaya Pemeliharaan per Tahun (Rp)
          </label>
          <input
            type="text"
            value={getDisplayValue('maintenanceCost')}
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">
            Nilai Residu/Trade-in (Rp)
          </label>
          <input
            type="text"
            value={getDisplayValue('residualValue')}
